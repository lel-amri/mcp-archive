...
#    url_class  = 'http://dl.dropbox.com/u/164771/classes.csv'
#    url_field  = 'http://dl.dropbox.com/u/164771/fields.csv'
#    url_method = 'http://dl.dropbox.com/u/164771/methods.csv'
    
    url_class  = 'https://mcp.ocean-labs.de/~mobius/renamer_csv/classes.csv'
    url_field  = 'https://mcp.ocean-labs.de/~mobius/renamer_csv/fields.csv'
    url_method = 'https://mcp.ocean-labs.de/~mobius/renamer_csv/methods.csv'    
